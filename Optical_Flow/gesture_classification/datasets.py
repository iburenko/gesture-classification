...
class SnippetClassificationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.use_keypoints == 0:
            #data = data["video_OF"][..., 0:1]/255
            #data =np.expand_dims(data,-1)


            '''modal_1= data["video_OF"][:,:,:,:3]/255
            modal_2 = data["video_OF"][:,:,:,:3]/255'''
            data =data["video_OF"][..., 3:6]/255
            
            #data = np.concatenate([modal_1,modal_2],axis=-1)
            ...
            #data=(vid_data-vid_mean)/vid_std
